...
VALUES
	...
	INSERT INTO Movie(Name,Image,Description,Time,Year,MovieLink,CountryID,Viewed,Rate,Status,CategoryID)
VALUES
	(N'THE MEDIUM',N'the-medium.jpg',N'Câu chuyện về gia đình một bà đồng, có khả năng kết nối với những âm hồn của thế giới bên kia luôn là đề tài gây nhiều hứng thú. Liệu sẽ ra sao nếu có sự xuất hiện của một linh hồn quỷ dữ đe dọa tính mạng của cả gia tộc?','115',2021,N'',101,651,8,1,107),
